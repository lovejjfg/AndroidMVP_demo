...
public class UIUtil {
     ...
     * @return
     */
    public static View getViewGroupByActivity(Activity activity){
        return  ((ViewGroup)((ViewGroup)activity.getWindow().getDecorView().findViewById(android.R.id.content)).getChildAt(0));
    }
}
